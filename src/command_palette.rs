...
pub fn build_commands(jvm_available: bool) -> Vec<CommandEntry> {
    let mut v = vec![
        ...
        entry(
            CommandKind::ToggleMouse,
            "Toggle mouse mode",
            "App",
            "Alt+m",
        ),
        entry(
            CommandKind::PickProject,
            "Pick Android project…",
            "Project",
            "w",
        ),
        entry(
            CommandKind::OpenWorkspaces,
            "Open saved workspaces…",
            "Project",
            "W",
        ),
        entry(
            CommandKind::SaveWorkspace,
            "Save current workspace",
            "Project",
            "S",
        ),
        entry(
            CommandKind::RunGradle,
            "Run Gradle default task",
            "Build",
            "r",
        ),
        entry(
            CommandKind::PickVariant,
            "Pick build variant…",
            "Build",
            "V",
        ),
        ...
        entry(
            CommandKind::OpenDeviceTools,
            "Open device tools…",
            "Device",
            "t",
        ),
        entry(
            CommandKind::LaunchEmulator,
            "Launch emulator AVD…",
            "Device",
            "e",
        ),
        entry(
            CommandKind::CycleFocusNext,
            "Focus next panel",
            "Layout",
            "Tab",
        ),
        entry(
            CommandKind::CycleFocusPrev,
        ...
        entry(
            CommandKind::ToggleZoom,
            "Toggle zoom focused panel",
            "Layout",
            "z",
        ),
    ];
