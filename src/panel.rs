...
impl PanelId {
    pub fn slug(self) -> &'static str {
        match self {
            ...
            PanelId::DeviceActions => "actions",
            PanelId::Shell => "shell",
            PanelId::AppControl => "app",
            PanelId::AppData => "data",
            PanelId::Manifest => "manifest",
...
pub const PANELS: &[PanelDef] = &[
    ...
    PanelDef { id: PanelId::DeviceActions, name: "actions", toggle_key: 'D', focus_key: 'o', requires: Feature::None },
    ...
    PanelDef { id: PanelId::Manifest,   name: "manifest",  toggle_key: 'M', focus_key: 'x', requires: Feature::None },
